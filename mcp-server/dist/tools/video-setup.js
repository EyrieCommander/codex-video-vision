...
export function registerVideoSetup(server) {
    server.tool("video_setup", "Check and install dependencies for video perception (ffmpeg, whisper, gemini api). Always asks permission before installing.", {
