...
export function registerVideoInfo(server) {
    server.tool("video_info", "Get metadata about a video file without processing it (duration, resolution, codec, etc.)", { path: z.string().describe("Absolute or relative path to the video file") }, async ({ path }) => {
