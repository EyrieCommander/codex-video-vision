 ...
 *             Codex's actual tokenizer for English text
 *
 * Numbers here are a lower-bound estimate. Codex's /context tracker
...
function printSingle(
  ...
  console.log(
    `\n(Codex's /context typically shows 10-15% higher due to wrapping overhead.)`,
  );
}
